...
class RecipeView  extends View {
    ...
    _generateMarkupIngredient(ing) {
        ...
        <div class="recipe_quantity">${ing.quantity? new Fraction(ing.quantity).toString() : ""}</div>
...
// only pass an instance of the class because we dont actually want there to be multiple instances(instead just one), but we do want private methods, and eventually some inheritance
